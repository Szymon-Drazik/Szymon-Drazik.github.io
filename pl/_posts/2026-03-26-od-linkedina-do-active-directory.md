...
> **⚠️ Zastrzeżenie:**
> *Niniejszy artykuł ma charakter wyłącznie edukacyjny i demonstracyjny. Zaprezentowane techniki oraz narzędzia (takie jak Kerbrute czy username-anarchy) powinny być wykorzystywane tylko i wyłącznie w ramach autoryzowanych testów penetracyjnych, legalnych działań audytowych lub w bezpiecznych, własnych środowiskach laboratoryjnych. Środowisko testowe (w tym domena ILF.local) widoczne na zrzutach ekranu pochodzi z platformy edukacyjnej [Hack The Box](https://www.hackthebox.com/). Nieautoryzowany dostęp do systemów informatycznych, infrastruktury firmowej oraz łamanie zabezpieczeń jest przestępstwem. Autor nie ponosi odpowiedzialności za jakiekolwiek niezgodne z prawem wykorzystanie wiedzy zawartej w tym wpisie.*>