...
### 4. Anonimowość pod przykryciem Tora
...
## Wyzwanie znajdź "wyciek"

W tym artykule pisałem o tym, jak niebezpieczne są sekrety zostawione w kodzie. Żeby nie być gołosłownym: **ten konkretny klucz wciąż znajduje się w historii tego repozytorium.**

**Twoje zadanie:**
Przeszukaj historię commitów [Szymon-Drazik.github.io](https://github.com/Szymon-Drazik/Szymon-Drazik.github.io) i spróbuj odnaleźć ten token. 

To proste ćwiczenie z zakresu reconu pokazuje, że raz wrzucony do sieci sekret zostaje w niej na zawsze nawet jeśli myślisz, że go usunąłeś. Jeśli go znajdziesz, daj znać!